...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # — AWAIT_TP_INPUT, DISAMBIGUOUS, NOTIFY_… —
    # Вставьте сюда вашу логику поиска/неоднозначности/выбора ВЛ,
    # как она была ранее, без изменений.

# === Блок обработки геолокации для уведомлений ===
