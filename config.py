...
VISIBILITY_GROUPS = {
    'All': list(BRANCH_URLS.keys()),
    'Россети ЮГ': [  # RK
        'Юго-Западные ЭС', 'Усть-Лабинские ЭС', 'Сочинские ЭС',
        'Славянские ЭС', 'Лабинские ЭС', 'Армавирские ЭС', 'Адыгейские ЭС',
    ],
    'Россети Кубань': [  # RU
        'Тимашевские ЭС', 'Тихорецкие ЭС', 'Ленинградские ЭС', 'Краснодарские ЭС'
    ],
}
